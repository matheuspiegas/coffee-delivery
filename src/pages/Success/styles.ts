...
export const HeadingContainer = styled.div`
  ...
  h1 {
    ...
    line-height: ${({ theme }) => theme.typography.baloo2.titles.l["line-height"]};
  }
  p {
...
export const OrderInfoItem = styled.div<OrderInfoItemProps>`
    ...
    > span {
      ...
      border-radius: 100%;
      ${(props) => css`
        background-color: ${props.variant === 'purple' ? props.theme.colors.product.purple : props.variant === 'yellow' ? props.theme.colors.product.yellow : props.theme.colors.product["yellow-dark"]};
      `}
